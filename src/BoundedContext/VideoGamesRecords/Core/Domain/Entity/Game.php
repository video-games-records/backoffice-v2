...
use App\BoundedContext\VideoGamesRecords\Core\Presentation\Api\Controller\Game\GetGameOfDay;
use App\BoundedContext\VideoGamesRecords\Core\Presentation\Api\Controller\Game\GetListByLetter;
use App\BoundedContext\VideoGamesRecords\Core\Presentation\Api\Controller\Game\GetPlayerGameRankingMedals;
use App\BoundedContext\VideoGamesRecords\Core\Presentation\Api\Controller\Game\GetPlayerGameRankingPoints;
use App\BoundedContext\VideoGamesRecords\Team\Presentation\Api\Controller\Game\GetTeamGameRankingMedals;
use App\BoundedContext\VideoGamesRecords\Team\Presentation\Api\Controller\Game\GetTeamGameRankingPoints;
use DateTime;
...
#[ApiResource(
    operations: [
        ...
        new Get(
            ...
            controller: GetPlayerGameRankingPoints::class,
            normalizationContext: ['groups' => [
                'player-game:read',
        ...
        new Get(
            ...
            controller: GetPlayerGameRankingMedals::class,
            normalizationContext: ['groups' => [
                'player-game:read',
        ...
        new Get(
            ...
            controller: GetTeamGameRankingPoints::class,
            normalizationContext: ['groups' => [
                'team-game:read',
        ...
        new Get(
            ...
            controller: GetTeamGameRankingMedals::class,
            normalizationContext: ['groups' => [
                'team-game:read',
                'team-game:team', 'team:read:minimal']
            ],
