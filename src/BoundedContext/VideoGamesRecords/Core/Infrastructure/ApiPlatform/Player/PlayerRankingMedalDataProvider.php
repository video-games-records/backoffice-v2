...
class PlayerRankingMedalDataProvider implements ProviderInterface
{
    ...
    /**
     * @return array<PlayerRankingMedalDTO>
     * @throws ORMException
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array
    {
        ...
        $players = $this->playerRankingProvider->getRankingMedals([
        ...
        return array_map(
            fn($player) => $this->playerMapper->toPlayerRankingMedalDTO($player),
            $players
        );
    }
}
