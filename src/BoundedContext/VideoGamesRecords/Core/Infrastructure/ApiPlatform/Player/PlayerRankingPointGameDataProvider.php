...
class PlayerRankingPointGameDataProvider implements ProviderInterface
{
    ...
    /**
     * @return array<PlayerRankingPointGameDTO>
     * @throws ORMException
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array
    {
        ...
        $players = $this->playerRankingProvider->getRankingPointGame([
        ...
        return array_map(
            fn($player) => $this->playerMapper->toPlayerRankingPointGameDTO($player),
            $players
        );
    }
}
