...
class PlayerRankingProofDataProvider implements ProviderInterface
{
    ...
    /**
     * @return array<PlayerRankingProofDTO>
     * @throws ORMException
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array
    {
        ...
        $players = $this->playerRankingProvider->getRankingProof([
        ...
        return array_map(
            fn($player) => $this->playerMapper->toPlayerRankingProofDTO($player),
            $players
        );
    }
}
