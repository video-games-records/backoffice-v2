    ...
    public function build(): void
    {
        ...
        if ($adminPlayer) {
            ...
            PlayerChartLibFactory::new()
                ->forPlayerChart($player1Chart->_real())
                ->withChartLib($marioAnyPercentChartLib->_real())
        ...
        if ($userPlayer) {
            ...
            PlayerChartLibFactory::new()
                ->forPlayerChart($player2Chart->_real())
                ->withChartLib($marioAnyPercentChartLib->_real())
        ...
        if ($moderatorPlayer) {
            ...
            PlayerChartLibFactory::new()
                ->forPlayerChart($player3Chart->_real())
                ->withChartLib($marioAnyPercentChartLib->_real())
                ->withTimeValue(1, 1, 8)
                ->create();
